...
const OurPolicy = () => {
  return (
    ...
    >
      <div>
        <img src={assets.exchange_icon} alt="exhange" className="w-12 m-auto mb-5" />
        <p className="font-semibold uppercase">easy exhange policy</p>
        <p className="text-gray-400">we offer hassle-free exchange policy</p>
      </div>
      <div>
        <img src={assets.quality_icon} alt="exhange" className="w-12 m-auto mb-5" />
        <p className="font-semibold uppercase">7 days return policy</p>
        <p className="text-gray-400">we offer 7-days free return policy</p>
      </div>
      <div>
        <img src={assets.support_img} alt="exhange" className="w-12 m-auto mb-5" />
